...
public class CreatArray5 : MonoBehaviour {
	...
	void gotoNextNode()
	{
		...
		else if(NodeType[intoIDi,intoIDj]==1)
		{
			...
			if(intoIDi-1>0)
			{
				...
				{
					//print("無法往左前進i="+intoIDi.ToString()+", j="+intoIDj.ToString());
				...
				{
					//print("會跑進黑洞i="+intoIDi.ToString()+", j="+intoIDj.ToString());
			...
			else if(intoIDi == 0)
			{
				...
				{
					//print("無法往左前進i="+intoIDi.ToString()+", j="+intoIDj.ToString());
					print("目前在i=" +intoIDi.ToString()+", j="+intoIDj.ToString() + ", 無法往左前進到i="+(node-1).ToString()+", j="+intoIDj.ToString()+", Type="+NodeType[intoIDi-1,intoIDj].ToString());
				}
		...
		else if(NodeType[intoIDi,intoIDj]==3)
		{
			...
			if(intoIDi < node)
			{
				...
				if(NodeType[intoIDi+1,intoIDj] == 1)
				{
					//print("無法往右前進i="+intoIDi.ToString()+", j="+intoIDj.ToString());
				...
				else
				{
					//將停留節點往左移動
					intoIDi=+1;
					//print("往右移動節點到i="+intoIDi.ToString()+", j="+intoIDj.ToString());
		...
		else if(NodeType[intoIDi,intoIDj]==2)
		{
			...
			if(intoIDj < layer-2)
			{
				...
				{
					//print("無法往上前進i="+intoIDi.ToString()+", j="+intoIDj.ToString());
				...
				else
				{
					//將停留節點往上移動
					intoIDj=+1;
					//print("往上移動節點到i="+intoIDi.ToString()+", j="+intoIDj.ToString());
		...
		else if(NodeType[intoIDi,intoIDj]==4)
		{
			...
			if(intoIDj > 1)
			{
				...
				{
					//print("無法往下前進i="+intoIDi.ToString()+", j="+intoIDj.ToString());
				...
				else
				{
					//將停留節點往下移動
					intoIDj=-1;
					//print("往下移動節點到i="+intoIDi.ToString()+", j="+intoIDj.ToString());
